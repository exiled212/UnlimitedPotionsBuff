...
namespace UnlimitedPotisBuff.Items.WrathPotion {
    public class WrathPotion : ModItem {

        public static string NAME = "Reliquia de ira";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.WrathPotion;
        public static int BUFF_ID = BuffID.Wrath;
