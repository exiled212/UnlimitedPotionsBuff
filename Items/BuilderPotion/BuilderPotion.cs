...
namespace UnlimitedPotisBuff.Items.BuilderPotion {
    public class BuilderPotion : ModItem {

        public static string NAME = "Reliquia constructora";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.BuilderPotion;
        public static int BUFF_ID = BuffID.Builder;
