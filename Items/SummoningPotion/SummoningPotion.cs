...
namespace UnlimitedPotisBuff.Items.SummoningPotion {
    public class SummoningPotion : ModItem {

        public static string NAME = "Reliquia de invocación"; 
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.SummoningPotion;
        public static int BUFF_ID = BuffID.Summoning;
