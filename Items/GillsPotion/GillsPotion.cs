...
namespace UnlimitedPotisBuff.Items.GillsPotion {
    public class GillsPotion : ModItem {

        public static string NAME = "Reliquia de agallas";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.GillsPotion;
        public static int BUFF_ID = BuffID.Gills;
