...
namespace UnlimitedPotisBuff.Items.RagePotion {
    public class RagePotion: ModItem {

        public static string NAME = "Reliquia de furia";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.RagePotion;
        public static int BUFF_ID = BuffID.Rage;
