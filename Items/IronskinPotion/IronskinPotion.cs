...
namespace UnlimitedPotisBuff.Items.IronskinPotion {
    public class IronskinPotion : ModItem {

        public static string NAME = "Reliquia de piel de hierro";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.IronskinPotion;
        public static int BUFF_ID = BuffID.Ironskin;
