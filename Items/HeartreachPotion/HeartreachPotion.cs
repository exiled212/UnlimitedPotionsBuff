...
namespace UnlimitedPotisBuff.Items.HeartreachPotion {
    public class HeartreachPotion : ModItem {

        public static string NAME = "Reliquia alcanzacorazón";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.HeartreachPotion;
        public static int BUFF_ID = BuffID.Heartreach;
