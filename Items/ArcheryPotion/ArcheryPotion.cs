...
namespace UnlimitedPotisBuff.Items.ArcheryPotion {
    public class ArcheryPotion: ModItem {

        public static string NAME = "Reliquia de arquero";
        public static string DESCRIPTION = "Esta reliquia te provee de su poder con solo tenerla";
        public static int ITEM_ID = ItemID.ArcheryPotion;
        public static int BUFF_ID = BuffID.Archery;
